        ...
        if (type === 'night2') {
            ...
            tutorialContent.innerHTML = `
                ...
                <p>
                    ...
                    TRUMP CAN BE LURED WITH THE AUDIOS BUT YOUR MAIN PRIORITY WITH THE AUDIO LURES SHOULD BE LUKE BEGGERS.
                </p>
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST LUKE</h2>
                <p>
                    LUKE BEGGERS ALWAYS STARTS AT CAM 11. USE THE CAMERA'S AUDIO LURE TO KEEP LUKE FAR AWAY FROM YOU. 
                    MAKE SURE THE CAMERA YOU'RE PLAYING THE SOUND IN IS NEXT TO THE CAMERA WHERE LUKE IS. 
                    ...
                    LUKE DOES NOT ATTACK THROUGH THE VENTS SO DON'T BOTHER CLOSING THEM FOR THIS NIGHT.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
